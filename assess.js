const solution = (arr = [], x, y) => {
    ...
    let highest_index = last_index_of_x > last_index_of_y ? last_index_of_x : last_index_of_y;
    let lowest_index = first_index_of_x < first_index_of_y ? first_index_of_x : first_index_of_y;
  
    if (num_of_x !== num_of_y) {
      const excess_highest = num_of_x > num_of_y ? next_to_last_index_x : next_to_last_index_of_y;
      const nonexcess_highest = num_of_x < num_of_y ? last_index_of_x : last_index_of_y;
      highest_index = excess_highest > nonexcess_highest ? excess_highest : nonexcess_highest;
    }
